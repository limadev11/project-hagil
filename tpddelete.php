...
if ($id > 0) {
    ...
    if ($result) {
        ...
        die('Erro ao buscar tipo de despesas.: ' . mysqli_error($con));
    }
} else {
    die('ID inválido.');
}
...
if (isset($_POST['submit'])) {
    // Deletar o usuário
    $sql = "DELETE FROM tipodespesa WHERE id = $id";
    $result = mysqli_query($con, $sql);
    ...
    if ($result) {
        ...
        die('Erro ao excluir tipo de despesas: ' . mysqli_error($con));
    }
}
?>
...
<body>
    ...
    <h2 class="text-center">Deletar Despesa</h2>
        ...
        <form action="" method="post">
            ...
            <div class="row">
                ...
                <div class="col-md-4 text-center mt-4">
                    <button type="button" class="btn btn-secondary rounded-pill py-3 px-5" onclick="window.location.href='tpdselect.php'"> Voltar</button>
                    <button type="submit" name="submit" class="btn btn-danger rounded-pill py-3 px-5">Deletar</button>
                </div>
            </div>
        </form>
    </div>
