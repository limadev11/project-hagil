...
if (!empty($_POST['pesqvend'])) {
    $pesqvend = mysqli_real_escape_string($con, $_POST['pesqvend']);
    // Parte em que o sql vai realizar a consulta do cliente
    $sql = "select v.id id, cli.nome cliente, p.nome produto, ve.id idv, ve.nome vendedor,
    v.precocusto, v.preco, v.quantidade, v.datavenda, v.valortotal
    from venda v
    inner join produto p
    on p.id = v.idproduto
    ...
    inner join cliente cli
    on cli.id = v.idcliente
    WHERE ve.nome LIKE '%$pesqvend%' or cli.nome LIKE '%$pesqvend%' or p.nome LIKE '%$pesqvend%';";
}
        ...
        <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s">
            <div class="container" style="background-color: transparent;">
                ...
                <form method="post" action="">
                    ...
                    <div class="row align-items-center" style="background-color: #556152; padding-top:5px; padding-bottom:5px; border-radius: 10px; width: 900px">
                        
                        <div class="col-auto">
                            <h5 style="color: white;">Venda parcial:</h5>
                        </div>
                        <div class="col-auto">
                            <input type="text" name="pesqvend" id="pesqvend" class="form-control" placeholder="Nome..." style="width: 350px;" value="<?php echo $pesqvend; ?>">
                        </div>
                        <div class="col-auto">
        ...
        <div class="table-container">
            ...
            <thead class="thead-dark">
                <tr>
                    ...
                    <th scope="col" style="background-color: #404A3D; color: white; width:40px">Cliente</th>
                    <th scope="col" style="background-color: #404A3D; color: white; width:50px">Produto</th>
