...
$comissao = str_replace(',', '.', $row['comissao']);
$estoque = str_replace(',', '.', $row['estoque']);
$precocusto = str_replace(',', '.', $row['precocusto']);
$precovenda = str_replace(',', '.', $row['precovenda']);
...
if (isset($_POST['submit'])) {
    ...
    $sql = 'UPDATE produto SET nome="' . $nome .
        '", preco="' . $preco . '", comissao="' . $comissao .
        '", estoque="' .  $estoque . '", precocusto="' .  $precocusto . '", precovenda="' .  $precovenda . '"where id=' . $id;
    $result = mysqli_query($con, $sql);
    if ($result) {
            ...
            <form method="post">
                ...
                <div class="row" style="background-color: #556152;">
                    <div class="col">
                        <?php
                        echo
                        "<a href='proselect.php?selectid={$row['id']}' style='color:white;'>
