...
if ($id > 0) {
    ...
    if ($result) {
        ...
        die('Erro ao buscar produto: ' . mysqli_error($con));
    }
} else {
    die('ID inválido.');
}
...
<body>
    ...
    <!-- Página de Deletar Produtos-->
    <div class="container my-5">
        <h2 class="text-center">Deletar Produtos</h2>
            ...
            <form action="" method="post">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" name="nome" value="<?php echo $nome; ?>" placeholder="Nome do Produto" readonly>
                    </div>

                    <div class="col-md-4">
                        <h5>Caixa:</h5>
                        <input type="number" class="form-control" name="email" value="<?php echo $estoque ; ?>" placeholder="Unidades" readonly>
                    </div>

                    <div class="col-md-4 text-center">
                        <button type="button" class="btn btn-secondary rounded-pill py-3 px-5" onclick="window.location.href='proselect.php'" style="margin-top: 15px;">Não, Voltar</button>
