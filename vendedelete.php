...
// Obter o ID do vendedor a ser excluído
...
if ($id > 0) {
    ...
    if ($result) {
        ...
        die('Erro ao buscar vendedor: ' . mysqli_error($con));
    }
} else {
    die('ID inválido.');
}
...
if (isset($_POST['submit'])) {
    ...
    if ($result) {
        ...
        die('Erro ao excluir vendedor: ' . mysqli_error($con));
    }
}
?>
...
<body>
    ...
    <!-- Página de Deletar Vendedor -->
    <div class="container my-5">
        <h2 class="text-center">Deletar Vendedor</h2>
            ...
            <form action="" method="post">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" name="nome" value="<?php echo htmlspecialchars($nome); ?>" placeholder="Nome do Vendedor" readonly>
                    </div>

                    <div class="col-md-4 text-center">
                        <button type="button" class="btn btn-secondary rounded-pill py-3 px-5" onclick="window.location.href='vendeselect.php'" style="margin-top: 18px;">Não, Voltar</button>
                        <button type="submit" name="submit" class="btn btn-danger rounded-pill py-3 px-5 mt-3" style="margin-left: 50px;">Deletar</button>
                    </div>
                </div>
            </form>
        </div>
