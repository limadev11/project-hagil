                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        echo "<tr>
                            ...
                            <td>
                                <a href='usuupdate.php?updateid=" . $row['id'] . "' class='btn btn-sm btn-primary mx-1'>Alterar</a>
                                <a href='usudelete.php?deleteid=" . $row['id'] . "' class='btn btn-sm btn-danger mx-1'>Excluir</a>
                            </td>
                          </tr>";
                    }
                } else {
