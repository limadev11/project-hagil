        ...
        <table class="table table-bordered" style="background-color: white; opacity: 94%; text-align: center;">
            <thead class="thead-dark">
                <tr>
                    ...
                    <th scope="col" style="background-color: #404A3D; color: white;">E-Mail</th>
                    <th scope="col" style="background-color: #404A3D; color: white;">Administrador</th>
            ...
            <tbody>
                ...
                <td>
                    <a href='usuupdate.php?updateid=" . $row['id'] . "' class='btn btn-dark'>Alterar</a>
                    <a href='usudelete.php?deleteid=" . $row['id'] . "' class='btn btn-dark'>Excluir</a>
                </td>
              </tr>";
                    }
                } else {
